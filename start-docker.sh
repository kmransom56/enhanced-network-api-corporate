...
if [ "$DETACHED" = true ]; then
    ...
    echo -e "  API:        ${GREEN}http://localhost:11111${NC}"
    echo -e "  Grafana:    ${GREEN}http://localhost:11112${NC}"
    echo -e "  Nginx HTTP: ${GREEN}http://localhost:11114${NC} (if configured)"
    echo -e "  Nginx HTTPS:${GREEN}https://localhost:11113${NC} (if configured)"
    echo ""
    echo "To view logs:"
